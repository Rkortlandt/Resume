  ...
  return (
    <div>
      <nav className="bg-slate-800 w-full h-19 flex-col flex lg:py-2 lg:px-1 lg:flex-row lg:fixed" id="nav">
          ...
          <button className="btn-nav-primary" onClick={() => window.scroll(0, 900)}>Technology skills</button>
          <button className="btn-nav-primary" onClick={() => window.scroll(0, 1500)}>References</button>
